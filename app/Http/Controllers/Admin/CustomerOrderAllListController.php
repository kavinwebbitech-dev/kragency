...
class CustomerOrderAllListController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.customer_orders.all', compact('orders'));
    }
    ...
    public function exportCsv(Request $request)
    {
        ...
        $fileName = 'customer_orders_' . now()->format('Ymd_His') . '.csv';
        ...
        $columns = [
            ...
            'Digit Added','Quantity','Amount','Winning Amount','Order Date'
        ];
